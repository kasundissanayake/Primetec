...
-(void)populateSummerySheet
{
    ...
    [fetchRequest setEntity:summarySheet1Entity];
    NSPredicate *predicate1 = [NSPredicate predicateWithFormat:@"ANY sMSheetNo == %@ AND project_id == %@", SMNo,appDelegate.projId];
    [fetchRequest setPredicate:predicate1];
    NSArray *summary1 = [context executeFetchRequest:fetchRequest error:&error];
    ...
    [fetchRequest setEntity:summarySheet2Entity];
    NSPredicate *predicate2 = [NSPredicate predicateWithFormat:@"ANY sMSSheetNo == %@ AND project_id == %@", SMNo,appDelegate.projId];
    [fetchRequest setPredicate:predicate2];
    NSArray *summary2 = [context executeFetchRequest:fetchRequest error:&error];
    ...
    [fetchRequest setEntity:summarySheet3Entity];
    NSPredicate *predicate3 = [NSPredicate predicateWithFormat:@"ANY sMSheetNo == %@ AND project_id == %@", SMNo,appDelegate.projId];
    [fetchRequest setPredicate:predicate3];
    NSArray *summary3 = [context executeFetchRequest:fetchRequest error:&error];
    ...
    if([summary1Dict count] > 0){
        NSLog(@"summary1Dict is %@",summary1Dict);
        id summaryReportObject = summary1Dict;
        NSLog(@"Summary Sheet Form object sMSheetNo: %@", [summaryReportObject valueForKey:@"sMSheetNo"]);
        
        appDelegate.sMSheetNo = [summaryReportObject valueForKey:@"sMSheetNo"];
        txtContractor.text=[summaryReportObject valueForKey:@"contractor"];
        txtPOBox.text=[summaryReportObject valueForKey:@"pOBox"];
        txtCity.text=[summaryReportObject valueForKey:@"city"];
        txtState.text=[summaryReportObject valueForKey:@"state"];
        ...
        //appDelegate.EdiSummarySheetNo=
        
        //   Radha
        appDelegate.DIlblProject = txtContractor.text;
        appDelegate.EditxtPOBox = txtPOBox.text;
        appDelegate.EditxtCity=txtCity.text;
        appDelegate.EditxtState=txtState.text;
        appDelegate.EditxtTpNumber=txtTpNumber.text;
        appDelegate.EditxtDate=txtDate.text;
        appDelegate.EditxtDateOfWork=txtDateOfWork.text;
        appDelegate.EditxtContactorPerform=txtContactorPerform.text;
        appDelegate.EditxtFederalAid=txtFederalAid.text;
        appDelegate.EditxtProjectNo=txtProjectNo.text;
        appDelegate.EditxvDesWork=txvDesWork.text;
        appDelegate.EditxvConsOrder=txvConsOrder.text;
        appDelegate.EditxtClass1=txtClass1.text;
        appDelegate.EditxtClass2=txtClass2.text;
        appDelegate.EditxtClass3=txtClass3.text;
        appDelegate.EditxtClass4=txtClass4.text;
        appDelegate.EditxtClass5=txtClass5.text;
        appDelegate.EditxtNo1=txtNo1.text;
        appDelegate.EditxtNo2=txtNo2.text;
        
        
        appDelegate.EditxtNo3=txtNo3.text;
        appDelegate.EditxtNo4=txtNo4.text;
        appDelegate.EditxtNo5=txtNo5.text;
        appDelegate.EditxtTotal1=txtTotal1.text;
        appDelegate.EditxtTotal2=txtTotal2.text;
        appDelegate.EditxtTotal3=txtTotal3.text;
        appDelegate.EditxtTotal4=txtTotal4.text;
        appDelegate.EditxtTotal5=txtTotal5.text;
        appDelegate.EditxtRate1=txtDes1.text;
        appDelegate.EditxtRate2=txtDes2.text;
        appDelegate.EditxtRate3=txtDes3.text;
        appDelegate.EditxtRate4=txtDes4.text;
        appDelegate.EditxtRate5=txtDES5.text;
        appDelegate.EditxtAmt1=txtQuantity1.text;
        appDelegate.EditxtAmt2=txtQuantity2.text;
        appDelegate.EditxtAmt3=txtQuantity3.text;
        appDelegate.EditxtAmt4=txtQuantity4.text;
        appDelegate.EditxtAmt5= txtQuantity5.text;
        appDelegate.EditxtTotalLabor=txtTotalLabor.text;
        
        
        appDelegate.EditxtHealth=txtHealth.text;
        appDelegate.EditxtInsTax=txtInsTax.text;
        appDelegate.Editxt20Items=txt20Items.text;
        appDelegate.EditxtTotalItems=txtTotalItems.text;
        appDelegate.EditxtDes1=txtDes1.text;
        appDelegate.EditxtDes2=txtDes2.text;
        appDelegate.EditxtDes3=txtDes3.text;
        appDelegate.EditxtDes4=txtDes4.text;
        appDelegate.EditxtDES5=txtDES5.text;
        appDelegate.EditxtQuantity1=txtQuantity1.text;
        appDelegate.EditxtQuantity2=txtQuantity2.text;
        appDelegate.EditxtQuantity3=txtQuantity3.text;
        appDelegate.EditxtQuantity4=txtQuantity4.text;
        appDelegate.EditxtQuantity5=txtQuantity5.text;
        appDelegate.EditxtUnitPrice1=txtUnitPrice1.text;
        appDelegate.EditxtUnitPrice2=txtUnitPrice2.text;
        appDelegate.EditxtUnitPrice3=txtUnitPrice3.text;
        appDelegate.EditxtUnitPrice4=txtUnitPrice4.text;
        appDelegate.EditxtUnitPrice5=txtUnitPrice5.text;
        appDelegate.EditxtMAmt1=txtMAmt1.text;
        appDelegate.EditxtMAmt2=txtMAmt2.text;
        appDelegate.EditxtMAmt3=txtMAmt3.text;
        appDelegate.EditxtMAmt4=txtMAmt4.text;
        appDelegate.EditxtMAmt5=txtMAmt5.text;
        appDelegate.EditxtTotalMeterial=txtTotalMeterial.text;
        appDelegate.EditxtLessDiscount=txtLessDiscount.text;
        appDelegate.EditxtLessDisTotal=txtLessDisTotal.text;
        appDelegate.EditxtAdditional=txtAdditional.text;
        appDelegate.EditxtAddTotal=txtAddTotal.text;
        
        appDelegate.EditxtSize1=txtSize1.text;
        appDelegate.EditxtSize2=txtSize2.text;
        appDelegate.EditxtSize3=txtSize3.text;
        appDelegate.EditxtSize4=txtSize4.text;
        appDelegate.EditxtSize5=txtSize5.text;
        appDelegate.EditxtActive1=txtActive1.text;
        appDelegate.EditxtActive2=txtActive2.text;
        appDelegate.EditxtActive3=txtActive3.text;
        appDelegate.EditxtActive4=txtActive4.text;
        appDelegate.EditxtActive5=txtActive5.text;
        appDelegate.EditxtENo1=txtENo1.text;
        appDelegate.EditxtENo2=txtENo2.text;
        appDelegate.EditxtENo3=txtENo3.text;
        appDelegate.EditxtENo4=txtENo4.text;
        appDelegate.EditxtENo5=txtENo5.text;
        appDelegate.EditxtETotal1=txtETotal1.text;
        appDelegate.EditxtETotal2=txtETotal2.text;
        appDelegate.EditxtEtotal3=txtEtotal3.text;
        appDelegate.EditxtETotal4=txtETotal4.text;
        appDelegate.EditxtETotal5=txtETotal5.text;
        appDelegate.EditxtERate1=txtERate1.text;
        appDelegate.EditxtERate2=txtERate2.text;
        appDelegate.EditxtERate3=txtERate3.text;
        appDelegate.EditxtERate4=txtERate4.text;
        appDelegate.EditxtERate5=txtERate5.text;
        appDelegate.EditxtEAmt1=txtEAmt1.text;
        appDelegate.EditxtEAmt2=txtEAmt2.text;
        appDelegate.EditxtEAmt3=txtEAmt3.text;
        appDelegate.EditxtEAmt4=txtEAmt4.text;
        appDelegate.EditxtEAmt5=txtEAmt5.text;
        appDelegate.EditxtInspector=txtInspector.text;
        appDelegate.EditxtContractorRepresentative=txtContractorRepresentative.text;
        appDelegate.EditxtConReDate=txtConReDate.text;
        appDelegate.EditxtDailyTotal=txtDailyTotal.text;
        appDelegate.EditxtTotalDate=txtTotalDate.text;
        appDelegate.EdisignName1=imgSignature.image;
        appDelegate.EdisignName2=imgSignature2.image;
        appDelegate.EditxtTotalDate=txtTotalDate.text;
        
        NSLog(@"Sfffffffffffffffffffffffffllll: %@", txtContractor.text);
        NSLog(@"Sfffffffffffffffffffffffffllll: %@", appDelegate.DIlblProject);
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:@"changeSummaryForm" object:nil userInfo:[NSDictionary dictionaryWithObjectsAndKeys:@"Edit",@"type", nil]];
    
    
    SummaryReportViewController *controller = [[SummaryReportViewController alloc] initWithNibName:@"SummaryReportViewController" bundle:nil];
    
    controller.total.text=txtContractor.text;
    NSLog(@"Sfffffffffffffffffffffffffllll: %@", controller.total.text);
