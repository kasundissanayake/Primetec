...
- (void)viewDidLoad
{
    ...
    {
        //Edit Tapped
        ERtxtApprovedBy.text = appDelegate.EEApprovedBy;
        cashAdvance.text = appDelegate.EECashAdvance;
        ERtxtCheckNum.text = appDelegate.EEChequeNumber;
        
        NSLog(@"check number is %@",appDelegate.EEChequeNumber);
        
        ERtextDate6.text = appDelegate.EEdate;
        ERtxtEmpName.text = appDelegate.EEEmpName;
        ERtxtEmpNum.text = appDelegate.EEEmpNo;
        ERtxtWeek.text = appDelegate.EEweekEnding;
        imgSignatureEx.image = appDelegate.EESign;
    }
}
...
- (IBAction)butSave:(id)sender {
    ...
    else
    {
        ...
        BOOL status = [PRIMECMController saveAllImages:sigName img:UIImageJPEGRepresentation( imgSignatureEx.image,1)];
