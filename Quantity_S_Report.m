...
-(void)loadExpenseEntries
{
    ...
    itemDetails = [[NSMutableArray alloc] init];
    itemDetails = [NSMutableArray arrayWithArray:[PRIMECMController getQuantitySummaryDetailsForProjectID:appDelegate.projId AndItemNum:[selectedDict objectForKey:@"item_no"]]];
    [quantityTable reloadData];
