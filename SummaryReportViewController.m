...
-(void)populateValues
{
    contractor.text=appDelegate.DIlblProject;
    pOBox.text= appDelegate.EditxtPOBox;
    city.text=appDelegate.EditxtCity;
    state.text=appDelegate.EditxtState;
    telephoneNo.text=appDelegate.EditxtTpNumber;
    date.text=appDelegate.EditxtDate;
    // appDelegate.EditxtDateOfWork=.text;     ///Lin check this
    conPeWork.text = appDelegate.EditxtContactorPerform;
    federalAidNumber.text=appDelegate.EditxtFederalAid;
    projectNo.text=appDelegate.EditxtProjectNo;
    descr.text=appDelegate.EditxvDesWork;
    constructionOrder.text=appDelegate.EditxvConsOrder;
    lAClass1.text=appDelegate.EditxtClass1;
    lAClass2.text=appDelegate.EditxtClass2;
    lAClass3.text=appDelegate.EditxtClass3;
    lAClass4.text=appDelegate.EditxtClass4;
    lAClass5.text=appDelegate.EditxtClass5;
    
    lANo1.text=appDelegate.EditxtNo1;
    lANo2.text=appDelegate.EditxtNo2;
    lANo3.text=appDelegate.EditxtNo3;
    lANo4.text=appDelegate.EditxtNo4;
    lANo5.text=appDelegate.EditxtNo5;
    lATotalHours1.text=appDelegate.EditxtTotal1;
    lATotalHours2.text=appDelegate.EditxtTotal2;
    lATotalHours3.text=appDelegate.EditxtTotal3;
    lATotalHours4.text=appDelegate.EditxtTotal4;
    lATotalHours5.text=appDelegate.EditxtTotal5;
    lARate1.text=appDelegate.EditxtRate1;
    lARate2.text=appDelegate.EditxtRate2;
    lARate3.text=appDelegate.EditxtRate3;
    lARate4.text=appDelegate.EditxtRate4;
    lARate5.text=appDelegate.EditxtRate5;
    lAAmount1.text=appDelegate.EditxtAmt1;
    lAAmount2.text=appDelegate.EditxtAmt2;
    lAAmount3.text=appDelegate.EditxtAmt3;
    lAAmount4.text=appDelegate.EditxtAmt4;
    lAAmount5.text=appDelegate.EditxtAmt5;
    totalLabor.text=appDelegate.EditxtTotalLabor;
    _sMSheetNo.text = appDelegate.sMSheetNo;
    healWelAndPension.text = appDelegate.EditxtHealth;
    insAndTaxesOnItem1.text = appDelegate.EditxtInsTax;
    itemDescount20per.text =  appDelegate.Editxt20Items;
    total.text = appDelegate.EditxtTotalItems;
    //   id1.text = appDelegate.iddd;
    /*
...
- (IBAction)next:(id)sender {
    ...
    /*
     ...
     //Radha
     BOOL saveStatus = [PRIMECMController
     saveSummarySheet1:@"Art"
     city:@"Hyd"
     conPeWork:@"Abc"
     constructionOrder:@"Abc"
     contractor:appDelegate.projId
     date:@"12-23-2014"
     descr:descr.text
     federalAidNumber:@"234"
     healWelAndPension:@"Hello"
     insAndTaxesOnItem1:@"Hello"
     itemDescount20per:@"2"
     lAAmount1:@"234"
     lAAmount2:@"235"
     lAAmount3:@"235"
     ...
     sSHeader:@"Hello"
     state:@"12121"
     telephoneNo:@"1213131313"
     total:@"12121212"
     totalLabor:@"1323232"
     zip:@"3232323"
     isEdit:isEdit
     ];
     NSLog(@"status is %d",saveStatus);
     [PRIMECMController totalObjectsOfSummarySheet];
