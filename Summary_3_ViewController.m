...
-(void)populateValues
{
    appDelegate.EditxtSize1=eQSizeandClass1.text;
    appDelegate.EditxtSize2=eQSizeandClass2.text;
    appDelegate.EditxtSize3=eQSizeandClass3.text;
    appDelegate.EditxtSize4=eQSizeandClass4.text;
    appDelegate.EditxtSize5=eQSizeandClass5.text;
    
    appDelegate.EditxtActive1=eQIdleActive1.text;
    appDelegate.EditxtActive2=eQIdleActive2.text;
    appDelegate.EditxtActive3=eQIdleActive3.text;
    appDelegate.EditxtActive4=eQIdleActive4.text;
    appDelegate.EditxtActive5=eQIdleActive5.text;
    
    appDelegate.EditxtENo1=eQNo1.text;
    appDelegate.EditxtENo2=eQNo2.text;
    appDelegate.EditxtENo3=eQNo3.text;
    appDelegate.EditxtENo4=eQNo4.text;
    appDelegate.EditxtENo5=eQNo5.text;
    
    appDelegate.EditxtETotal1=eQTotalHours1.text;
    appDelegate.EditxtETotal2=eQTotalHours2.text;
    appDelegate.EditxtEtotal3=eQTotalHours3.text;
    appDelegate.EditxtETotal4=eQTotalHours4.text;
    appDelegate.EditxtETotal5=eQTotalHours5.text;
    
    appDelegate.EditxtERate1=eQRAte1.text;
    appDelegate.EditxtERate2=eQRAte2.text;
    appDelegate.EditxtERate3=eQRAte3.text;
    appDelegate.EditxtERate4=eQRAte4.text;
    appDelegate.EditxtERate5=eQRAte5.text;
    
    appDelegate.EditxtEAmt1=eQAmount1.text;
    appDelegate.EditxtEAmt2=eQAmount2.text;
    appDelegate.EditxtEAmt3=eQAmount3.text;
    appDelegate.EditxtEAmt4=eQAmount4.text;
    appDelegate.EditxtEAmt5=eQAmount5.text;
    
    appDelegate.EditxtInspector=inspector.text;
    appDelegate.EditxtContractorRepresentative=contractorRepresentative.text;
    appDelegate.EditxtConReDate=date1.text;
    appDelegate.EditxtDailyTotal=dailyTotal.text;
    appDelegate.EditxtTotalDate=total_to_date.text;
    appDelegate.EdisignName1=signature1.image;
    appDelegate.EdisignName2=signature2.image;
