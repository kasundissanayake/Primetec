...
-(void)populateNonComplianceForm
{
    ...
    */
    ...
    if([objects count] > 0){
        ...
        NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"http://data.privytext.us/noncompliance/%@",
                                           [NSString stringWithFormat:@"%@.jpg", [nonComplianceReportObject valueForKey:@"Signature"]]]];
        NSLog(@"url----%@",url);
